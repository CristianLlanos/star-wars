...
class MoviesIndexRequest extends FormRequest
{
    ...
    {
        return [
            'title.string' => 'The title filter must be a string.',
            'title.min' => 'The title filter must be at least :min characters.',
            'title.max' => 'The title filter may not be greater than :max characters.',
